...
namespace Library
{
    ...
    public class PwmController : IPwmDriver, IDisposable, IPwmControllerProvider
    {
        private I2cDevice _servoPiHat;
        private readonly byte _baseAddress;
        private bool _initialized;

        public const int SERVO_MIN = 150;
        public const int SERVO_MAX = 450;
        ...
        public void Test()
        {
            this.SetPulseParameters(0, SERVO_MIN, false);
            Task.Delay(TimeSpan.FromMilliseconds(250)).Wait();
            this.SetPulseParameters(0, SERVO_MAX, false);
            Task.Delay(TimeSpan.FromMilliseconds(250)).Wait();
        }
        ...
        /// <param name="invertPolarity"></param>
        public void SetPulseParametersToAll(double value, bool invertPolarity = false)
        {
            // Clamp value between 0 and 4095 inclusive. 
        ...
        {
            SetPulseParameters(servo, SERVO_MIN + (percentage * interval));
        }
